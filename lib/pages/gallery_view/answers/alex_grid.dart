...
class AlexGrid extends StatelessWidget {
  const AlexGrid({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return const TestScalableGridViewPage();
  }
}
...
class TestScalableGridViewPage extends StatefulWidget {
  ...
  @override
  State<TestScalableGridViewPage> createState() =>
...
class ScalableGridView extends StatefulWidget {
  ...
  @override
  State<ScalableGridView> createState() => _ScalableGridViewState();
}
...
class _ScalableGridViewState extends State<ScalableGridView>
  ...
  void _handleScaleUpdate(ScaleUpdateDetails details) {
    ...
    // Similar to above.
    // 与上步同理。
    if (delta > 0 && _scale.value + delta > _maximumScale) {
